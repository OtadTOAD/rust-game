use nalgebra_glm::{
    TMat4, half_pi, identity, look_at, perspective, pi, rotate_normalized_axis, translate, vec3,
};
...
fn main() {
    ...
    let instance = {
        ...
        Instance::new(
            ...
            InstanceCreateInfo {
                ...
                enumerate_portability: true, // macOS support
    ...
    let vertex_buffers = CpuAccessibleBuffer::from_iter(
        &memory_allocator,
        BufferUsage {
            vertex_buffer: true,
            ..BufferUsage::empty()
